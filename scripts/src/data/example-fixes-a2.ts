// Правки примеров, уровень A2. Общее описание слоя — в example-fixes.ts.
import type { ExampleFix } from "./example-fixes";

// Батч 1 — отдельные слова.
...
// Батч 2 — словосочетания и фразы (pos: "phrase" и родственные). Примеров у них
// не было вообще: карточка показывала «in the end — в конце концов», и куда это
// вставлять в речь, ученик не узнавал. Плейсхолдеры (sth, sb, …) в примере
// раскрыты конкретным словом.
...
export const A2_FIXES: Record<string, ExampleFix> = { ...A2_WORDS, ...A2_PHRASES };
