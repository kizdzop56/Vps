...
//   read — пользователь открыл уведомление. Гасит счётчик у колокольчика.
...
// дня, учителю — сданные работы, разборы диалогов и заявки на время.
// ─────────────────────────────────────────────────────────────────────────────
...
export type NotificationKind =
  ...
  /** Ученик сдал работу или прошёл диалог. */
  | "submission"
  /** Запись на занятие или предложенное учеником время. */
  | "booking"
  /** Ученик принял приглашение учителя. */
  | "student_joined";
