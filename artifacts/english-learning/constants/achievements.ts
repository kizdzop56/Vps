...
//
// В приложении 63 медали, распределённые по сложности:
//   • easy   — 19 медалей — быстрые победы, ≈1–24 ч в приложении
//   • medium — 31 медаль  — устойчивая активность, ≈24–80 ч
//   • hard   — 13 медалей — долгосрочное мастерство, ≈80 ч+
//
...
// У медалей раздела «Учёба» рендеров пока нет — появятся, достаточно положить
// файл в assets/badges/medals и дописать строку в BADGE_IMAGES.
//
