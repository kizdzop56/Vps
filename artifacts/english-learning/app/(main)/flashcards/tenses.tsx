...
//
// Уровня на карточке каждого времени тоже больше нет: время может быть
// помечено уровнем НИЖЕ текущего уровня ученика (это нормально — Present
// Simple остаётся Present Simple и на A2), и надпись «A1» на карточке рядом со
// своим же бейджем «A2» наверху читалась как рассинхрон, а не как факт.
//
          ...
          return (
            ...
            >
              ...
              >
                ...
                {/* Уровень времени убран отсюда: см. «Чего здесь нет» в шапке файла. */}
