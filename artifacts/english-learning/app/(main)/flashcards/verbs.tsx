...
// глаголы отдельной строкой: именно с ними и стоит идти в предложения.
//
...
export default function IrregularVerbsScreen() {
  ...
  /** Слабые глаголы: по ним и стоит идти в предложения. */
  ...
  return (
    ...
    >
      ...
      {/* Переключатель. Нижняя грань только у выбранной вкладки: она «нажата»,
          и это видно, не читая подписей. */}
      <View style={{
        flexDirection: "row",
          ...
          {weakVerbs.length > 0 && (
            <Tile glow={colors.warning} style={{ padding: 15, marginTop: 14 }}>
              ...
              <Text style={{ fontSize: 12, lineHeight: 18, color: colors.mutedForeground, marginTop: 10 }}>
                Эти глаголы чаще попадаются в заданиях, пока точность не
                подрастёт. Отдельно искать их не нужно.
              </Text>
            </Tile>
          )}
