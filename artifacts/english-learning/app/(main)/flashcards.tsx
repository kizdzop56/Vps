...
//
// ── Куда ведут карточки ─────────────────────────────────────────────────────
// Слова, сборка предложений и неправильные глаголы начинаются сразу: выбирать
// там нечего. Времена ведут на ПРОМЕЖУТОЧНЫЙ экран выбора времени — гонять все
// времена вперемешку почти бесполезно, ученик каждый раз выводит форму с нуля
// вместо того, чтобы увидеть закономерность.
//
