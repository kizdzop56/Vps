...
// всем колодам), отработка сложных слов, тематические колоды, собственные
          ...
          {themeDecks.length > 0 && (
            <>
              ...
              <Text style={{ fontSize: 12, lineHeight: 18, color: colors.mutedForeground, marginBottom: 10 }}>
                Темы наполняются по мере изучения. Остальные слова приходят сами
                в «Учить слова» и «Марафоне слов» — по твоему уровню.
              </Text>
