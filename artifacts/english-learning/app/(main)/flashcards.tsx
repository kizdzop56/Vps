...
// неправильные глаголы, времена, разговор с тьютором, — и деть их было некуда:
...
const MODES: Mode[] = [
  ...
  {
    key: "tutor",
    title: "Разговор с тьютором",
    // Единственный режим, где отвечают голосом, — это и сказано первым словом.
    about: "Говоришь вслух, тьютор отвечает голосом и мягко поправляет ошибки",
    icon: "sound",
