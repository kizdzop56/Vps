...
//
// Состав ленты зависит от роли и решается на сервере: ученику медали и задачи
// дня, учителю — сданные работы, разборы диалогов и заявки на время в
// календаре. Здесь эта разница не видна: строка рисуется по kind.
//
        ...
        <View style={{
          ...
          {selected ? (
            ...
            <View style={{ alignItems: "center", paddingVertical: 44, gap: 12 }}>
              ...
              {/* Текст без перечисления ученических событий: у учителя тут
                  будут ответы учеников и заявки на время, а не медали. */}
              <Text style={{
                fontSize: 14, color: colors.mutedForeground,
                textAlign: "center", lineHeight: 20, paddingHorizontal: 20,
              }}>
                Пока пусто. Здесь появится всё важное: ответы на задания, заявки и награды.
              </Text>
            </View>
          ) : (
