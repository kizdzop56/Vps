...
//
// Живёт в раскладке вкладок и монтирован для любого ученика, но реально что-то
// рисует только во время боя рейда: данные приходят из шины (utils/raidBus.ts),
// а она слушает ответ ровно одного запроса — POST /raid/answer. Раньше сюда же
// прилетали удары из обычного тренажёра слов и грамматики, и цифра урона
// вылетала поверх карточки со словом, хотя ученик рейд даже не открывал — это
// убрано (см. шапку raidBus.ts).
//
