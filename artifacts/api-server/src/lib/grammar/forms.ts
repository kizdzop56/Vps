 ...
 * Верные ответы.
 *
 * Массив, а не строка: у части глаголов две равноправные формы (learnt и
 * learned), и объявлять одну правильной значит спорить с учебником ученика.
 */
export function formAnswers(task: FormTask): string[] {
  if (task.kind === "toEn") return [task.verb.base];
