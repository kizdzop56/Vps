...
// Пять тем — столько же, сколько разрешает выбрать клиент (MAX_INTERESTS в
// components/AboutCard.tsx). Значения обязаны совпадать: иначе интерфейс
// показывает «выбрано 5 из 5», а сервер молча обрезает список по-своему.
